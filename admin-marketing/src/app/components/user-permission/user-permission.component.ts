...
export class UserPermissionComponent implements OnInit {
    ...
    */
    setOptionDatatable(){
        ...
        let column_3 = { targets: 3,visible: false, searchable: false };
        let column_5 = { targets: 5,visible: false, searchable: false };
        let column_6 = { targets: 6,visible: false, searchable: false };
